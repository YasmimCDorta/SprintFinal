...
namespace Somativa.Controllers
{
	...
	public class FornecedoresController : Controller
    {
        ...
        public FornecedoresController(SprintContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FornecedorNome,Nome,Cnpj")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("FornecedorNome,Nome,Cnpj")] Fornecedor fornecedor)
        {
