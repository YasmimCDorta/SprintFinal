...
namespace Somativa.Controllers
{
	...
	public class ProdutosController : Controller
    {
        ...
        public async Task<decimal> Preco([FromRoute] Guid Id)
        {
            var unitario = _context.Produtos?.FirstOrDefault(p => p.ProdutoId.Equals(Id)).Preco;
            return (decimal)(unitario == null ? 0 : unitario);
        }
    }
}
